...
% 
% INPUTS:
% X_norm  : Matrix of total-count normalized single cell gene expression data with size p x q, where p=(# genes),
%                     q=(# cells).
% 
% tot_counts  : Vector length q with the total number of UMI-filtered mapped transcripts per cell across all genes, before normalization.
%
